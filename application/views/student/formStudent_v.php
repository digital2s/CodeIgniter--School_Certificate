        ...
        <?= form_open_multipart('c_student/validFormUpdateStudent'); ?>

        <div aria-hidden="true" class="modal fade"  id="modal"  tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
               ...
               <input type="hidden" value="<?= set_value('hidden_id', $student_id) ;?>" name="hidden_id" >


        <div class="form-group">
    <label for="formGroupExampleInput">First name</label>
    <input type="text"  value="<?= set_value('text_fname', $student_fname) ;?>       "  name="text_fname" class="form-control"  id="fname" >
    <?= form_error('text_fname');  ?>
  </div>
  <div class="form-group">
    <label for="formGroupExampleInput2">Last name</label>
     <input type="text" name="text_lname" class="form-control" id="formGroupExampleInput"
 value="<?= set_value('text_lname', $student_lname) ;?>       "
>
  ...
  <div class="form-group">
    <label for="formGroupExampleInput2">Staff Member First Name</label>
     <input type="text"  name="text_staff_member_fname" class="form-control" id="formGroupExampleInput"
      ...
      value="<?= set_value('text_staff_member_fname', $staff_member_fname) ;?>  ">
 ...
 value="<?= set_value('text_staff_member_lname', $staff_member_lname) ;?>  ">
       <?= form_error('text_staff_member_lname');  ?>
  </div>

      <div class="form-group">
    <label for="formGroupExampleInput5">Picture</label>
     <input type="text"  name="text_picture" class="form-control" id="formGroupExampleInput5"
 
     value="<?= set_value('text_picture', $student_img) ;?>  ">
        <?= form_error('text_picture');  ?>
  </div>
