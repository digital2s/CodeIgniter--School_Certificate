  ...
  <?= form_open('c_speciality/validFormUpdateSpeciality'); ?>
...
<div aria-hidden="true" class="modal fade"  id="modal"  tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
  <div class="modal-dialog" role="document">
    ...
    <input type="hidden"  name="hidden_id" class="form-control"  id=""   
    value="<?= set_value('hidden_id', $speciality->speciality_id) ;?>">
    <input type="text"  name="text_speciality" class="form-control"  id=""   
    value="<?= set_value('text_speciality', $speciality->speciality_label) ;?>">
